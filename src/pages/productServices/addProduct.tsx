...
const NewProductServices = () => {
  ...
  } = useMutation(createProductService)
  ...
  const createProduct = (data) => {
    ...
    const formatProduct = {
      ...
      image: imgCloudfile ? imgCloudfile : '/addPhoto.png',
    }

    // console.log(formatProduct)
    createProductMutation(formatProduct)
  }
  ...
  useEffect(() => {
    ...
    if (isError) {
      toast({
        title: 'Error ao salvar registro!',
        duration: 2000,
        status: 'warning',
        position: 'top',
      })
